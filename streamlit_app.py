...
st.info("💡Select plant from the dropdown and enter your AGS email. Then click anywhere on the **floor map** view to plot a leak. Scroll down to to edit more details and submit a report.")
